pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/benzink'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/benzink/225-lab3-7.git'                                    //<------your MiamiID
        KUBECONFIG = credentials('benzink-225')                                                         //<------your MiamiID
    }
        ...
        stage ("Run Security Checks") {
            steps {
                ...
                sh '''
                    ...
                    -e BURP_START_URL=http://10.2.3.245 \
